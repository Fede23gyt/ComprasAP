...
<template>
    <AppLayout title="Tipos de Insumo">
        <section class="bg-gray-100 dark:bg-gray-900 pt-4 pb-6">
            <div class="max-w-7xl mx-auto px-4">
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Tipos de Insumos</h1>
            </div>
        </section>
            ...
            <div class="overflow-x-auto rounded-xl shadow">
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tr v-for="item in items" :key="item.id" class="h-4 text-xs hover:bg-gray-50 dark:hover:bg-gray-700/30">
                        ...
                        <td class="px-4 py-1">
                            <Link :href="`/tipo_insumo/${item.id}/edit`" class="text-secondary hover:text-orange-500">✏️</Link>
                        </td>
                    </tr>
                    </tbody>
                </table>
