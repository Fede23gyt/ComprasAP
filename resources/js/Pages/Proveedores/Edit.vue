...
const form = useForm({
  ...
  tipo: props.proveedor.tipo || '',
  domicilio: props.proveedor.domicilio || '',
  telefono_fijo: props.proveedor.telefono_fijo || '',
  telefono_celular: props.proveedor.telefono_celular || '',
  email: props.proveedor.email || '',
  estado: props.proveedor.estado !== undefined ? props.proveedor.estado : true
});
...
const submit = () => {
  ...
  form.patch(route('nomencladores.proveedores.update', props.proveedor.id));
};
</script>
    ...
    <template #header>
      <div class="flex items-center justify-between">
        ...
        <div class="flex space-x-2">
          <Link
            :href="route('nomencladores.proveedores.show', proveedor.id)"
