        ...
        >
            ...
            >
                ...
                <div class="grid grid-cols-2 gap-4 items-center">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-200">Oficina padre</label>
                ...
                <div class="flex justify-end space-x-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                    ...
                    <button
                        ...
                        class="px-6 py-2 rounded-md bg-accent text-white hover:bg-red-600 transition disabled:opacity-50"
                    >
                        Grabar
                    </button>
                </div>
